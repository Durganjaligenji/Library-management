...
public class BookController {
	...
	public ResponseEntity<Book> saveBook(@RequestBody Book book) {
	    ...
	    for (Publisher publisher : book.getPublishers()) {
	        ...
	        System.out.println("Found Publisher: " + foundPublisher);
	    ...
	    Book createdBook = bookService.saveOrUpdatBook(book);
	...
	public ResponseEntity<Book> updateBook(@PathVariable int id, @RequestBody Book book) {
	    ...
	    book.setId(id);
	    Book updatedBook = bookService.saveOrUpdatBook(book);
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Book> deletetBook(@PathVariable int id){
		Book book=bookService.getBookById(id);
		if(book == null) {
			return ResponseEntity.notFound().build();
		}
